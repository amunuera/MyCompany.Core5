...
using MyCompany.Core5.Models.TokenAuth;
...
{
    public abstract class Core5WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Core5WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Core5WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Core5DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Core5DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Core5DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Core5DbContext, Task<T>> func)
        {
            T result;
